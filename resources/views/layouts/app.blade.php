...
<body class="bg-gray-50 text-gray-800 transition-colors duration-300">
        ...
        <nav class="max-w-6xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-3">
                    {{-- CTA Button --}}
                    <a href="/tes/phq9" 
                       class="hidden sm:inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-xl font-medium shadow-lg shadow-blue-600/30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200">
                        Mulai Tes
                    </a>
    ...
    <button id="scroll-to-top" 
            class="fixed bottom-8 right-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 rounded-full shadow-lg opacity-0 invisible hover:scale-110 transition-all duration-300 z-40"
